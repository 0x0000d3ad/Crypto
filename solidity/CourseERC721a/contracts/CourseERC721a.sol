...
/**
 ...
 / ___|___  _   _ _ __ ___  ___| ____|  _ \ / ___|___  |___ \/ | __ _ 
| |   / _ \| | | | '__/ __|/ _ \  _| | |_) | |      / /  __) | |/ _` |
| |__| (_) | |_| | |  \__ \  __/ |___|  _ <| |___  / /  / __/| | (_| |
 \____\___/ \__,_|_|  |___/\___|_____|_| \_\\____|/_/  |_____|_|\__,_|
...
// File: contracts/CourseERC721a.sol
// Creator: Chiru Labs
...
contract CourseERC721a is ERC721A, Ownable {
	using Strings for uint256;
	...
	uint256 public maxMintAmount = 10;		// max amount anyone, can mint per wallet
	...
	uint256 public whitelistCost = 0.005 ether;	// whitelist mint cost
	...
	string _name = "Course ERC721a Token";
	string _symbol = "C721";
	...
	returns (string memory)
	{
		...
		string memory traits = string( abi.encodePacked( ', "attributes": [{"trait_type": "Type","value": "', tokenId.toString(), '}], ' ) );

		string memory svg1 = '<svg width="200" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg"><rect x="0" y="0" width="200" height="200" stroke="red" stroke-width="10px" fill="white"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="60">';
		string memory svg2 = '</text></svg>';
		string memory svg_image = string(abi.encodePacked( svg1, tokenId.toString(), svg2 ) );

		string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Course ERC721a Token #', tokenId.toString(), '", "description": "Fully on-chain ERC721a example contract."', traits, '"image": "data:image/svg+xml;base64,', Base64.encode(bytes(svg_image)), '"}'))));
